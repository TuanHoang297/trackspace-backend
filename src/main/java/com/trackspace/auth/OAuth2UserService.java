...
/**
 * Processes the Google OAuth2 user.
...
public class OAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User createUser(String email, String name) {
        ...
        // OAuth2 users have no password — store an unguessable non-BCrypt string
        // so normal password login is impossible for this account
