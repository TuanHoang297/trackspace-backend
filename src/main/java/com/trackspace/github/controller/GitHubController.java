...
public class GitHubController {
    ...
    public ResponseEntity<ApiResponse<List<CommitResponse>>> getCommits(
        ...
        log.debug("GET /api/v1/github/commits/{} - userId={}, since={}, until={}", projectId, userId, since, until);
        List<CommitResponse> commits = commitService.getCommits(projectId, userId, since, until);
    ...
    public ResponseEntity<ApiResponse<List<StatsResponse>>> getStats(
        ...
        log.debug("GET /api/v1/github/stats/{} - userId={}", projectId, userId);
        List<StatsResponse> stats = commitService.getStats(projectId, userId);
